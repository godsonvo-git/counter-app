...
* **Increment, Decrement, & Reset:** Instantly update the counter value with dedicated interactive buttons[cite: 2, 3].
...
* **HTML5:** Semantic structural layout[cite: 2].
* **CSS3:** Custom Flexbox positioning, shadows, dynamic color styling, and custom font imports[cite: 1].
* **JavaScript (ES6):** DOM selection (`document.getElementById`), click event listeners, and dynamic text updates (`textContent`).
...
├── main.js        # Dynamic DOM logic
└── icon-1.png     # Page favicon
